...
export default {
  mounted() {
    ...
    this.$store.commit("toggleLoadingTrue");
                    ...
                    if (!error) {
                      ...
                      fb.auth
                        ...
                        .then(user => {
                          ...
                          vuex.$store.commit("setCurrentUser", user.user);
                          vuex.$store.dispatch("fetchUserProfile").then(() => {
                            vuex.$router.push("/");
                            vuex.$store.commit("toggleLoadingFalse");
                          });
                        })
                        .catch(err => {
                          console.log(err);
